...
cbAzimutal    = checkbox(bind=test,text="Sans force",   checked=True);  scene.append_to_caption("   ")
...
def start(b):
    ...
    tabCoriolis = graph(title='Amplitude des forces', xtitle='Temps (s)', ytitle='Amplitude (N)',align='right')
    ...
    courbeAzimutal = gcurve(graph=tabCoriolis, label='Sans force',color=couleurs_force['azimutal'])
