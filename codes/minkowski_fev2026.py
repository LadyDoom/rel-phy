...
# === Toutes les fonctions définies en premier ===
...
def ajouter_segment_manuellement(b):
    ...
    # tracer directement le segment
    seg = curve(pos=[p1, p2], radius=0.06, color=color.magenta)
    objetsMagenta.append(seg)

    # petites lignes d'univers translucides au long du segment
    n = 5
...
def decomposer_position(evt=None):
